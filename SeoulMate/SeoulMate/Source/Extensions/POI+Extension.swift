...
extension POI {
    var assetImageName: String {
        ...
        case "명동성당": return "Myeongdong Cathedral"
        case "청계천": return "Cheonggyecheon"
        case "광장시장": return "Gwangjang Market"
    ...
    private var categoryAssetName: String {
        ...
        case "역사유적", "궁궐", "사찰": return "palace"
        case "전시관", "미술관", "박물관": return "museum"
        case "시장": return "market"
        case "공원", "도심공원": return "park"
        case "거리": return "street"
        case "전망", "전망대": return "tower"
        case "복합문화공간": return "culture"
        case "쇼핑몰", "옷가게": return "shopping"
        case "건축": return "architecture"
        case "야경": return "nightview"
